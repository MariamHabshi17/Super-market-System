...
public class EmpLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("We trut in you !");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if(jTextField1.getText().equals("MsMStore".trim())&&jPasswordField1.getText().equals("MsMStore".trim())){
        new Prodsystem().setVisible(true);
        setVisible(false);        
        }else{
        JOptionPane.showMessageDialog(this, "Cheack username or password !");
        }
        }else{
        JOptionPane.showMessageDialog(this, "You should enter all fields !");
        }
